...
We introduced the Base 4 case for nodes because we can prove that we need to visit all of the nodes in this graph. This is equivalent to saying that each of the Collatz Variants, $\ColMod{N}{A}{4}$ terminates for nonempty $A \subseteq \{0,1,2,3\}$, and for any input number $x_i$. 
\begin{theorem}
$\ColMod{N}{A}{4}$ terminates for nonempty $A \subseteq \{0,1,2,3\}$.
\end{theorem}
\begin{proof}
We will start with proving that $\ColMod{N}{\{2\}}{4}$ will terminate for any input number $x_i$, because the 2 node is central to the Base 4 graph.\par
\begin{lemma}
\label{lem:collatzSubTwoModFour}
$\ColMod{N}{\{2\}}{4}$ terminates for any $x_i$.
\end{lemma} 
\begin{proof}
...
\end{itemize}
Since all other nodes must visit node 2, it means that for all $x_i$, $\ColMod{N}{\{2\}}{4}$ terminates.
\end{proof} \par

\begin{lemma}
\label{lem:collatzSubOneModFour}
$\ColMod{N}{\{1\}}{4}$ terminates for any $x_i$.
\end{lemma}
\begin{proof}
...
$\ColMod{N}{\{0\}}{4}$ terminates for any $x_i$.
\end{lemma}
\begin{proof}
...
$\ColMod{N}{\{3\}}{4}$ terminates for any $x_i$.
\end{lemma}
\begin{proof}
